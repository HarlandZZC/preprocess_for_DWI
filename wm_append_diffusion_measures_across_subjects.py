...
import glob
# conda activate WMA
# python /home/haolin/Research/Preprocess/wm_append_diffusion_measures_across_subjects.py inputfolder appenedmeasurefile.csv
...
# anatomical tracts
stats = pandas.read_table(os.path.join(subject_folders[0], f'ses-1/dwi/WMA/{os.path.basename(subject_folders[0])}_ses-1_run-1_tractography_NFW/AnatomicalTracts/diffusion_measurements_anatomical_tracts.csv'), delimiter=' , ')
...
for s_idx, subject_folder in enumerate(subject_folders):
    ...
    csv = os.path.join(subject_folder, f'ses-1/dwi/WMA/{os.path.basename(subject_folder)}_ses-1_run-1_tractography/AnatomicalTracts/diffusion_measurements_anatomical_tracts.csv')
...
# Fiber clusters 
stats = pandas.read_table(os.path.join(subject_folders[0], f'ses-1/dwi/WMA/{os.path.basename(subject_folders[0])}_ses-1_run-1_tractography/FiberClustering/SeparatedClusters/diffusion_measurements_commissural.csv'), delimiter=' , ')
...
for s_idx, subject_folder in enumerate(subject_folders):
    ...
    csv = os.path.join(subject_folder, f'ses-1/dwi/WMA/{os.path.basename(subject_folder)}_ses-1_run-1_tractography/FiberClustering/SeparatedClusters/diffusion_measurements_left_hemisphere.csv')
    stats = pandas.read_table(csv, delimiter=' , ')
    ...
    csv = os.path.join(subject_folder, f'ses-1/dwi/WMA/{os.path.basename(subject_folder)}_ses-1_run-1_tractography/FiberClustering/SeparatedClusters/diffusion_measurements_right_hemisphere.csv')
    stats = pandas.read_table(csv, delimiter=' , ')
    ...
    csv = os.path.join(subject_folder, f'ses-1/dwi/WMA/{os.path.basename(subject_folder)}_ses-1_run-1_tractography/FiberClustering/SeparatedClusters/diffusion_measurements_commissural.csv')
    stats = pandas.read_table(csv, delimiter=' , ')
